...
?>
            <tr>
                ...
                <td>
                    <a href="edit_automovil.php?edit_id=<?php echo $row['id'] ?>"> Editar</a>
                </td>
                <td>
...
<?php
    ...
    {
        try {
            $stmt = $this->db->prepare("UPDATE automovil SET matricula=:matricula, marca=:marca, 
            modelo=:modelo, color=:color, precio=:precio
            WHERE id=:id");
